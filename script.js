...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const cvop = document.getElementById('cvop');
    generateCVButton.addEventListener('click', () => {
        ...
        const skillsListInCV = document.querySelector('.skills-list2');
        ...
        const educationListInCV = document.getElementById('education-list');
        educationListInCV.innerHTML = ''; // Clear existing education
        const educationInputs = document.querySelectorAll('.education-form');
        educationInputs.forEach(div => {
            const programInput = div.querySelector('input[name="program"]');
            const schoolInput = div.querySelector('input[name="school"]');
        ...
        const experienceListInCV = document.getElementById('experience-list');
        experienceListInCV.innerHTML = ''; // Clear existing experience
        const experienceInputs = document.querySelectorAll('.experience-form');
